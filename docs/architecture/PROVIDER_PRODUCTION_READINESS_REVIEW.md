...
|------|-------|
| **Version** | **v1.86.5** |
| **Commit** | `4a53c6102a4a14b6f863919e9f6209400b825a64` |
| **Tag** | `v1.86.5` |
| **Branch** | `main` |
...
| **Quality Pipeline（current evidence）** | **1232 PASS**（Quality Enforcement Correction lineage under released `v1.86.5`） |
