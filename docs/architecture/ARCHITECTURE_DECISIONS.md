...
- [ADR-0023](../adr/ADR-0023-repository-baseline-inventory-authority.md) — Repository Baseline Inventory Authority Decision（Accepted — v1.86.0 **Released**; corrective v1.86.1 Commit Preparation）
...
### Post–ADR-0023 — Repository Baseline Inventory Authority（v1.86.0 Released）

| Item | Decision |
|------|----------|
| **ADR** | [ADR-0023](../adr/ADR-0023-repository-baseline-inventory-authority.md) |
| **Status** | Accepted（v1.86.0 — Repository Baseline Inventory Authority Governance — **Released**） |
...
| **Current Baseline Record population** | **Complete** for released baseline `v1.86.0`（authorized Record values in [BASELINE_SYNCHRONIZATION.md](./BASELINE_SYNCHRONIZATION.md) §6.2.2 — commit `57b3182…` / tag `v1.86.0`） |
| **Repository-wide Synchronization** | **Complete** under released `v1.86.0`; corrective **v1.86.1** Identity Reconciliation Independent Review **Complete** — Decision **A. GO**; current phase **Commit Preparation** |
...
| **v1.86.1 Corrective Release** | **Commit Preparation / Not Declared** — Independent Review **Complete** — Decision **A. GO**; Commit / Tag / Push **Pending** |
| **Provider Production Ready（global）** | **Not Declared** |
| **Repository-wide Level 4** | **Not Declared** |
| **Consequences** | Decision index discovers ADR-0023; Current Baseline Record population for `v1.86.0` is complete; Required Derived Target sync and Quality Enforcement Correction completed for release; Independent Review Complete — Decision **A. GO**（including v1.86.1 Identity Reconciliation IR）; Commit / tag / push for `v1.86.0` **Complete**; corrective `v1.86.1` at **Commit Preparation** with Commit / Tag / Push **Pending**; `ARCHITECTURE_DECISIONS.md` remains index / discovery surface only |

```text
ADR accepted
≠ automatic release declaration（historical planning distinction）
v1.86.0 Released（commit 57b3182… / tag v1.86.0）
≠ v1.86.1 released（Pending / Not Declared）
