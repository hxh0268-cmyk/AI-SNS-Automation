...
- Migration 7 による本書更新は **それ自体では release 宣言ではない**（historical: did not declare `v1.86.0`; `v1.86.0`, `v1.86.1`, `v1.86.2`, and `v1.86.3` are now **Released**; Pending corrective is `v1.86.4`）
