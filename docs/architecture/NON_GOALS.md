...
> **Current Phase（v1.75.0）:** Mock Provider Catalog Registration Governance **Complete** — Catalog concrete registration **Authorized / Not Started**。Real Provider external IO は **禁止維持**。
...
- **Mock Provider Catalog Registration Authorized / Not Started** — ADR-0017; separate future Implementation Release
