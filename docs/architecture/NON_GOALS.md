...
> **Current Phase（v1.76.0）:** Mock Provider Catalog Registration **Registered** — concrete `text-generation-mock-provider` in `providerContracts[]`。Real Provider external IO は **禁止維持**。
