...
| 文書 | 役割 |
|------|------|
| [PROVIDER_EXPANSION_ENTRY_REVIEW.md](./PROVIDER_EXPANSION_ENTRY_REVIEW.md) | **Provider Expansion Entry Review** — expansion taxonomy / entry criteria / blocking conditions / Expansion Entry Authorization **Not Granted**（v1.79.0） |
...
## 現在フェーズ（v1.79.0 — Provider Expansion Entry Governance Release）
